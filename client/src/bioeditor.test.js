...
test(`Clicking the "Save" button causes an ajax request. 
    ...
    console.log("container BEFORE event: ", container.querySelector("button").innerHTML); // "Edit"
    fireEvent.click(container.querySelector("button"));
    console.log("container AFTER event: ", container.querySelector("button").innerHTML); // "Save"
